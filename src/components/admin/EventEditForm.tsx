  ...
  return (
    <div>
      ...
      {tab === "content" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div>
            <label className="swa-form-label">About the Event (short description)</label>
            <textarea
          ...
          <div>
            ...
            <p style={{ fontSize: "0.78rem", color: "#9CA3AF", marginBottom: 8 }}>
              Supports plain text with line breaks. You can include numbered lists — start lines with 1. 2. 3.
            </p>
            <textarea
              className={T} rows={18} value={form.body}
...
2. Learn to identify emotional triggers…
