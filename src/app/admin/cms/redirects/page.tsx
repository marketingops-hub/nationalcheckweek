...
export default async function RedirectsPage() {
  ...
  return (
    <div>
      ...
      {/* Info banner */}
      <div className="rounded-lg px-4 py-3 mb-6 flex items-start gap-3" style={{ background: 'var(--admin-accent-bg)', border: '1px solid rgba(19,181,234,0.15)' }}>
        <svg className="mt-0.5 flex-shrink-0" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#13b5ea" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
