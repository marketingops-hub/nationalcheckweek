...
export const metadata = {
  title: "Become an Ambassador — Schools Wellbeing Australia",
  description: "Apply to become a Schools Wellbeing Ambassador and champion student wellbeing across Australia.",
};
