import NominateFormClient from "@/components/ambassadors/NominateFormClient";
import Link from "next/link";

export const metadata = {
  title: "Nominate an Ambassador — National Check-in Week",
  description: "Know someone who champions student wellbeing? Nominate them to become a National Check-in Week Ambassador.",
};
